...
#include <memory>
#include "../../projekt_3/mainwindow3.h"
...
Q_CONSTINIT static const qt_meta_stringdata_MainWindow3_t qt_meta_stringdata_MainWindow3 = {
    {
        ...
        QT_MOC_LITERAL(12, 41),  // "on_actionPowr_t_do_menu_g_wne..."
        QT_MOC_LITERAL(54, 0)   // ""
    },
    "MainWindow3",
    "on_actionPowr_t_do_menu_g_wnego_triggered",
    ""
};
...
Q_CONSTINIT const QMetaObject MainWindow3::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_MainWindow3_t,
        ...
        // method 'on_actionPowr_t_do_menu_g_wnego_triggered'
...
void MainWindow3::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_actionPowr_t_do_menu_g_wnego_triggered(); break;
        default: ;
        }
    }
    (void)_a;
